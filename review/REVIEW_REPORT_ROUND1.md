...
> **Historical engineering review.** This report predates the empirical
> provenance audit and does not validate benchmark superiority. See
> `FINAL_REVIEW_VERDICT.md` and `RESPONSE_TO_R1_R2.md` for current status.
