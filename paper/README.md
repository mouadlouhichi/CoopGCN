...
| File | Description |
|---|---|
| `coopgcn_array.tex` | Manuscript source (`elsarticle.cls`, `preprint,12pt,authoryear`) |
| `references.bib` | 18 references, BibTeX |
...
| `CoopGCN_Array_preview.pdf` | Rendered preview (15 pp.) |
